    ...
    return (
        <Layout>
            <div className="min-h-screen bg-black text-white py-12">
                ...
                >
                    <h1 className="text-5xl md:text-6xl font-sans text-gold mb-6">
                        Про нас
                    </h1>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800">
                            <h2 className="text-3xl font-sans text-gold mb-4">
                                Навіщо нам гліптотека?
                            </h2>
                            <p className="text-gray-300 font-body text-lg mb-4">
                                <strong className="text-gold">Діана Клочко</strong>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="space-y-12">
                        ...
                        >
                            <p className="text-gray-300 font-body text-lg leading-relaxed">
                                ...
                                <strong className="text-gold"> Людвіг І Баварський</strong>. Він був противником Наполеона,
                        ...
                        >
                            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 hover:border-gold transition-colors">
                                <h3 className="text-2xl font-sans text-gold mb-4">Мюнхенська Гліптотека</h3>
                            ...
                            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 hover:border-gold transition-colors">
                                <h3 className="text-2xl font-sans text-gold mb-4">Гліптотека Карлсберга</h3>
                                <p className="text-gray-300 font-body leading-relaxed">
                        ...
                        >
                            <h3 className="text-3xl font-sans text-gold mb-6 text-center">
                                Сучасна ера гліптотек
                            </h3>
                            <div className="text-gray-300 font-body text-lg leading-relaxed space-y-4">
                                <p>
                        ...
                        >
                            <div className="bg-gradient-to-r from-zinc-900 to-black rounded-2xl p-8 border border-gold">
                                <h2 className="text-4xl font-sans text-gold mb-6">
                                    Навіщо нам, українцям, гліптотека?
                                </h2>
                                <div className="text-gray-300 font-body text-lg leading-relaxed space-y-4 max-w-4xl mx-auto">
                                    <p>
                        ...
                        >
                            <div className="max-w-4xl mx-auto">
                                <h3 className="text-2xl font-sans text-gold mb-6">
                                    Наша місія
                                </h3>
                ...
                {/* Decorative Elements */}
                <div className="absolute top-0 left-0 w-72 h-72 bg-gold opacity-5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
