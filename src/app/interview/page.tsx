...
const InterviewPage: React.FC = () => {
    ...
    return (
        <Layout>
            <main className="bg-gray-100 text-black min-h-screen py-16 px-6">
                <div className="max-w-2xl mx-auto space-y-8">
                    {/* Заголовок сторінки */}
                    <div className="text-center mb-12">
                        <h1 className="text-3xl md:text-4xl font-light text-black tracking-wide mb-4">
                            Glyptotheque
                        </h1>
                        <div className="w-24 h-px bg-gray-100 bg-opacity-50 mx-auto"></div>
                    ...
                    <div className="border border-gold border-opacity-30 rounded-xl overflow-hidden transition-all duration-500 hover:border-opacity-50">
                        <button
                            ...
                            className="w-full text-left p-6 bg-black bg-opacity-5 hover:bg-opacity-10 transition-all duration-300 group"
                        >
